/*==============================================================================
DO FILE NAME:			05b_an_ps_descriptive_plots_copd
PROJECT:				ICS in COVID-19 
AUTHORS:				A Schultze, A Wong, C Rentsch 
						adapted from K Baskharan, E Williamson 
DATE: 					12th of May 2020
VERSION: 				Stata 16.1 
DESCRIPTION OF FILE:	adapted 05 for the IPW population 
...
* Open a log file
capture log close
log using $logdir\05b_an_ps_descriptive_plots_copd, replace t
...
sts graph, by(exposure) failure 							    			///	
		   title("Time to $tableoutcome, $population population IP weighted", justification(left) size(medsmall) )  	   ///
