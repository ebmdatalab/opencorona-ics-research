/*==============================================================================
DO FILE NAME:			S1-10_models_ethnicity 
...
OTHER OUTPUT: 			logfiles, printed to folder analysis/$logdir
						S1-table6, printed to analysis/$outdir
...
cap log close
log using $logdir\S1-10_an_models_ethnicity_copd, replace t
...
* Column headings 
file write tablecontent ("S1 Table 6: Association between current ICS use and ONS COVID-19 death - $population Population ethnicity == 1") _n
