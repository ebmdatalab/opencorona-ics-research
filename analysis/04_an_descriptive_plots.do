...
************************************************************* CTR NOTES: this should run cumulative probabilities of failure of CPNS death by exposure
...
*** USED IN RISK FACTORS PUBLICATION *******;
...
*** OTHER BITS CTR HASNT LOOKOED AT YET *******;
