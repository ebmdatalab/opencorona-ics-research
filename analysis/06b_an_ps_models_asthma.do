/*==============================================================================
DO FILE NAME:			06b_an_ps_models_asthma
...
cap log close
log using $logdir\06b_an_ps_models_asthma, replace t
...
post temp ("$tableoutcome") ("$population") ("PS - IPW") ("`lab2'") (round(r(estimate)),0.01) (round(r(lb)),0.01) (round(r(ub)),0.01)  
