...
sts graph, by(exposure) failure 							    			///	
		   ...
		   text(0.0019 22 " unadjusted HR (low/med ICS) = 1.36, 95%CI = 1.01 - 1.84", size(vsmall)) ///
		   text(0.0018 20 " unadjusted HR (high ICS) = 2.30, 95%CI = 1.64 - 3.23", size(vsmall)) ///
		   text(0.0017 21 " adjusted HR (low/med ICS) = 1.14, 95%CI = 0.84 - 1.54", size(vsmall)) ///
